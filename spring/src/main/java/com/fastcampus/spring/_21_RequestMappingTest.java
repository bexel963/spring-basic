...
@Controller
public class _21_RequestMappingTest {
//  @RequestMapping({"/login/hello.do", "/login/hi.do"}) 
    ...
    @RequestMapping("/login/**/tmp/*.do")   // /login/tmp/hello.do, /login/aaa/tmp/hello.do, /login/aaaa/tmp/hello.do, /login/aa/bb/tmp/hello.do
    public void test3(){
